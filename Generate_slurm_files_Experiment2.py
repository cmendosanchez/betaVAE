...
betas = ['2']
train_index = ['1']
output = f'/neurospin/dico/cmendoza/Runs/01_betavae_sulci_crops/Program/betaVAE/configs/slurm_files/{Hemi}_{Region}/Experiment2'
    ...
    for latent_dim in latent_dimensions:
        ...
        for beta in betas:
            ...
            for train_idx in train_index:
                ...
                cd $WORK
                cd PhD_UKB/betaVAE
                python3 main.py n={latent_dim} kl={beta} nb_epoch=30 +dataset_folder=/lustre/fsn1/projects/rech/tgu/ugf68us/{Hemi}_{Region}_numpy_all_crops_sift2 +save_dir=/lustre/fswork/projects/rech/tgu/ugf68us/PhD_UKB/betaVAE_Output +dataset=$dataset +MSE_loss=True +preproc=LogMinMax +split=CustomSplit +train_list=/lustre/fsn1/projects/rech/tgu/ugf68us/{Hemi}_{Region}_numpy_all_crops_sift2/Train_{train_idx}.csv +validation_list=/lustre/fsn1/projects/rech/tgu/ugf68us/{Hemi}_{Region}_numpy_all_crops_sift2/Validation_{train_idx}.csv""")
