...
output = f'/neurospin/dico/cmendoza/Runs/01_betavae_sulci_crops/Program/betaVAE/configs/slurm_files/{Hemi}_{Region}/Optuna_tuning_Experiment3'
...
for config_name in config_names:
    ...
    #SBATCH --cpus-per-task=32           # nombre de CPU par tache pour gpu_p5 (1/8 des CPU du noeud 8-GPU A100)
    ...
    #SBATCH -A tgu@a100                  # choice of the partition
    ...
    cd $WORK
    cd PhD_UKB/betaVAE
    python3 Optuna_tuning.py +dataset_folder=/lustre/fsn1/projects/rech/tgu/ugf68us/{Hemi}_{Region}_numpy_all_crops_sift2 +save_dir=/lustre/fswork/projects/rech/tgu/ugf68us/PhD_UKB/betaVAE_Output +dataset=$dataset""")
